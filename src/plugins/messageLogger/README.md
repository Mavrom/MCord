...
Davranış, [Vencord'un resmi MessageLogger kaynağı](https://github.com/Vendicated/Vencord/tree/ce4e84277e7de349f07e0d4d5820370d4c31f80a/src/plugins/messageLogger)
ve yerel HistoryModal görünümü incelenerek MCord API'lerine uyarlandı.
Vencord dosyalarının birebir kopyası değildir.
...
- MCord uyarlamasında geçmiş metni güvenli düz metin olarak gösterilir;
  Vencord'un özel Markdown ayrıştırıcısı ve grup halinde daraltma bileşeni
...
başlatmak gerekir. MessageStore ve düzenlendi etiketi yamaları, Vencord'da
